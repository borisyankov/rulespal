...
*It has been widely rumored that during his imprisonment Atahuallpa introduced Pizarro to the Perudo dice game. Indeed the game is played throughout Spain today, as it is in Peru.*
...
* 30 dice, 6 cups, 1 cup lid, cloth pouch.
...
* Each player rolls one die: the highest roll starts the bidding.
...
* Once the bidding has started, another option is available: the call of "aces". This is a prediction of how many aces there will be. To do this, the number of dice predicted is halved from that of the previous bid. So a bid of "eight sixes" can be followed by a call of "four aces" (or "five aces" etc). Fractions are always rounded up, so a call of "eleven threes" becomes an aces bid of at least "six aces".
...
## Demonstration Hand Between 6 Players

* Player 1: 1st call: 10 fours; 2nd call: 16 twos
* Player 2: 1st call: 10 sixes; 2nd call: 8 aces
* Player 3: 1st call: 11 twos; 2nd call: Dudo
* Player 4: 1st call: 13 twos
* Player 5: 1st call: 7 aces
* Player 6: 1st call: 15 twos

**Conclusion:** Player 3 (the challenger) revealed his die followed in sequence by player 4, 5, 6, 1 and 2. Player 2 loses a die on account of there being only 7 aces. Player 2 starts the next hand with 4 dice.
