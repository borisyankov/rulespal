  ...
  return (
    <article className="mx-auto max-w-screen-sm">
      ...
      <Markdown
        ...
        prose-h3:mb-3  
        prose-h3:mt-6
        prose-h3:text-2xl prose-h3:tracking-wide
        prose-h4:mt-4 prose-h4:text-xl prose-h4:tracking-wide
        prose-h5:text-lg
        prose-h5:font-bold prose-h5:tracking-wide prose-h6:font-bold prose-h6:tracking-wide
        prose-p:my-3 prose-a:font-bold 
        prose-a:decoration-primary
        prose-a:decoration-2
        prose-a:underline-offset-2 prose-ol:my-2 prose-ul:my-2
        prose-ul:pl-5 prose-li:my-0 prose-li:p-0 prose-li:leading-snug
        prose-hr:my-8 sm:text-lg
        "
